                            ...
                            <div class="widget-main">
                                <form id="form" method="post" action="/student/addstudent.do" class="form-horizontal" role="form" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class=" form-control " value="" type="text" autocomplete="off" name="sex">
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-8 col-sm-11">
                                                    <div class="input-group">
                                                        <input class="form-control date-picker" id="id-date-picker-1" type="text" name="birthday" data-date-format="dd-mm-yyyy" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class=" form-control " value="" type="file"  name="img">
                                        </div>
                                    </div>
